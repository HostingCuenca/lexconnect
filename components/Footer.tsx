      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2 text-gray-300">
                ...
                <span className="font-sans">Guayaquil, Ecuador</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300">
                <Phone className="h-4 w-4" />
                <span className="font-sans">+593 98 831 6157</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 mb-4 md:mb-0 font-sans text-center md:text-left">
              <p>© 2025 LexConnect Ecuador. Todos los derechos reservados.</p>
