        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl">LexConnect</span>
            </div>
            <p className="text-gray-300 mb-6">
              Conectando abogados y clientes de manera eficiente. 
              Conectamos clientes con los mejores abogados especializados.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2 text-gray-300">
                ...
                <span>contacto@lexconnect.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 mb-4 md:mb-0">
              © 2024 LexConnect. Todos los derechos reservados.
            </p>
